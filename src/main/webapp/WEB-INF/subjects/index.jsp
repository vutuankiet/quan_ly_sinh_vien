        ...
        <div class="table-responsive">
            <table class="table table-striped display text-nowrap">
                ...
                <c:forEach var="sj" items="${requestScope.table_data}">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="ModalCenter${sj.id}" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle${sj.id}" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-12 col-lg-8">
                                            <h6 class="font-bold">Subject name:<span class="ml-3 font-normal">${sj.name}</span></h6>
                                            <h6 class="font-bold">State:<span class="ml-3 font-normal">${sj.local_state == 1 ? "<button class='btn btn-info' disabled>Active</button>":"<button class='btn btn-danger' disabled>Locked</button>"}</span></h6>
                                        </div>
                                    </div>
                                </div>
...
<div class="dataTables_paginate paging_simple_numbers">
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-end">
            <%if(current_page > 1){%>
            <li class="page-item">
                <a class="page-link" href="${pageContext.request.contextPath}/subjects?page=<%=current_page - 1%>">Previous</a>
            </li>
            <% } %>

            <% for (int i = 1; i <= total_page; i++) { %>
            <% if (i == current_page) {%>
            <li class="page-item"><a href="${pageContext.request.contextPath}/subjects?page=<%=i%>"
            ...
            <li class="page-item">
                <a class="page-link" href="${pageContext.request.contextPath}/subjects?page=<%=current_page + 1%>">Next</a>
            </li>
            <% } %>
        </ul>
    </nav>
