                ...
                <c:forEach var="st" items="${requestScope.table_data}">
                    <tr>
                        <td class="text-center"><img src="${pageContext.request.contextPath}/Uploads/${st.avatar}"
                                                     alt="student-image" width="80" height="80"></td>
                        <td>${st.name}</td>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-4 text-center mb-5">
                                            <img src="${pageContext.request.contextPath}/Uploads/${st.avatar}"
                                                 alt="student-image" class="img-fluid" width="200" height="200">
                                        </div>
                                        <div class="col-12 col-lg-8">
                                            ...
                                            <h6 class="font-bold">State:<span
                                                    class="ml-3 font-normal">${st.local_state == 1 ? "<button class='btn btn-info' disabled>Active</button>":"<button class='btn btn-danger' disabled>Locked</button>"}</span>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
...
<div class="dataTables_paginate paging_simple_numbers">
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-end">
            ...
            <li class="page-item">
                <a class="page-link"
                   href="${pageContext.request.contextPath}/students-search?page=<%=current_page - 1%>&st_name=${requestScope.name_key}&cl_name=${requestScope.class_key}">Previous</a>
            </li>
            <% } %>
            ...
            <li class="page-item"><a
                    href="${pageContext.request.contextPath}/students-search?page=<%=i%>&st_name=${requestScope.name_key}&cl_name=${requestScope.class_key}"
            ...
            <li class="page-item">
                <a class="page-link" href="${pageContext.request.contextPath}/students-search?page=<%=current_page + 1%>&st_name=${requestScope.name_key}&cl_name=${requestScope.class_key}">Next</a>
            </li>
            <% } %>
        </ul>
    </nav>
