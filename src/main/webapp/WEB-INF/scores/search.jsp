...
<div class="dataTables_paginate paging_simple_numbers">
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-end">
            ...
            <li class="page-item">
                <a class="page-link"
                   href="${pageContext.request.contextPath}/scores-search?page=<%=current_page - 1%>&st_name=${requestScope.name_key}&sj_name=${requestScope.subject_key}&cl_name=${requestScope.class_key}">Previous</a>
            </li>
            <% } %>

            <% for (int i = 1; i <= total_page + 1; i++) { %>
            <% if (i == current_page) {%>
            <li class="page-item"><a href="${pageContext.request.contextPath}/scores-search?page=<%=i%>&st_name=${requestScope.name_key}&sj_name=${requestScope.subject_key}&cl_name=${requestScope.class_key}"
            ...
            <li class="page-item">
                <a class="page-link" href="${pageContext.request.contextPath}/scores-search?page=<%=current_page + 1%>&st_name=${requestScope.name_key}&sj_name=${requestScope.subject_key}&cl_name=${requestScope.class_key}">Next</a>
            </li>
            <% } %>
        </ul>
    </nav>
